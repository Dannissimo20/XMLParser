...
public class DictionarysLib
{
    public static readonly Dictionary<string, string> StateDictionary = new Dictionary<string, string>()
    {
        { "\"\"", ""},
        {"01", "Ранее учтенный" },
        {"05", "Временный" },
    ...
    public static readonly Dictionary<string, string> ObjectDictionary = new Dictionary<string, string>()
    {
        {"p", "Земельный участок" },
        {"s", "Часть земельного участка" },
        {"c", "Контур земельного участка" },
        {"t","Сооружение" },
    };
    public static readonly Dictionary<string, string> CategoryDictionary = new Dictionary<string, string>()
    {
        { "\"\"", ""},
    ...
    public static readonly Dictionary<string, string> UtilizationDictionary = new Dictionary<string, string>()
    {
        { "\"\"", ""},
        ...
        {"142002 050000", "Для размещения объектов общественного питания"},
    ...
    public static readonly Dictionary<string, string> ObjectTypeDictionary = new Dictionary<string, string>()
    {
        {"002001000000", "Объекты учёта и регистрации" },
        {"002001001000", "Земельный участок" },
        {"002001002000", "Здание" },
        {"002001003000", "Помещение" },
        {"002001004000", "Сооружение" },
        {"002001004001", "Линейное сооружение, расположенное более чем в одном кадастровом округе" },
        ...
        {"002002004000", "Граница населённого пункта" },
        {"002003000000", "Зоны" },
        {"002003001000", "Зона с особыми условиями использования территорий" },
        {"002003002000", "Территориальная зона" },
        {"002003003000", "Особая экономическая зона" },
        {"002004000000", "Территория объекта культурного наследия" },
    };
    public static readonly Dictionary<string, string> KeyTypeDictionary = new Dictionary<string, string>()
    {
        {"01", "Протяженность" },
        {"02", "Глубина" },
        {"03", "Объем" },
